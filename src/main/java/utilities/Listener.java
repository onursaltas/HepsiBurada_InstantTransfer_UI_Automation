...
public class Listener extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("UI HepsiBurada Automation Report"); // Tile of report
		htmlReporter.config().setReportName("UI HepsiBurada Testing Report"); // name of the report
